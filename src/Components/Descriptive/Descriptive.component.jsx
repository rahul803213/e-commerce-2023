...
import './Descriptive.Styles.scss'
import CustomButton from '../custom-button/custom-button.component';

export default function DescriptivePage(props) {
    ...
    <>
     <div className='description'>
            ...
            <div className="left-side">
                <img src={url} alt='tree'/>
            </div>

            {/* second column -> right side*/}
            <div className="right-side">
                <header>
                    <h3>Product's title</h3>
                </header> 
                <p style={{color:'green', fontWeight:'600', fontSize: '14px'}}>special Price</p>
                <p>&#8377;{price}</p>
                {/* i icon dalna hai yahan pe */}

                <div className='sizes'>
                    <span> size: </span>
                    <CustomButton children="XXL" style={{width: '50px'}}/>
                    <CustomButton children="XL"/>
                    <CustomButton children="L"/>
                    <CustomButton children="M"/>
                    <CustomButton children="S"/>
                </div>
                <hr/>
                <div className='Product-detail'>
                    <p>Product details</p>
                    <p onClick={handleOnClick} style={{fontSize
                    : '25px',fontWeight: '400'}}>{sign}</p>
                </div>
                {/* <div className='Product-detail'>
